...
class Lists extends Component {
   ...
   componentDidMount() {
      this.loadData = $('#datatable').DataTable({
         ...
         serverSide: true,
         ajax: {
            url: siteURL + '/admin/akun/getData',
            type: 'POST'
         },
         createdRow: (row) => {
            ...
            _edit.onclick = () => {
               open(siteURL + '/admin/akun/edit/' + _edit.dataset.id, '_parent')
            }
   ...
   _delete(id) {
      ...
      axios.
         post('/admin/akun/delete', formData).
         then(res => {
            ...
            <Row className="page-titles">
               ...
               <Col md={3} className="align-self-center">
                  <Button
                     ...
                     size="sm"
                     onClick={() => open(siteURL + '/admin/akun/tambah', '_parent')}
                  >Tambah</Button>
               </Col>
            </Row>
            <Row>
